...
Original file is located at
    https://colab.research.google.com/drive/1K46xoMuFLp5T0PtqRdzQ5oaVtgd01oYw
"""
...
with tab1:
    ...
    # Prepare delivery satisfaction data
    ...
    # Prepare rating by delivery band and shipping status for heatmap
    if "Delivery_Band" in filtered_df.columns:
        ...
        st.info("No 'Delivery_Band' column found in data for heatmap.")

    # Prepare product sales for barplot
    product_sales = (
